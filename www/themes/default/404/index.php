...
<body>
    ...
    <div class="error">
        ...
        <div class="error__description">Parece que los desarrolladores se han quedado fritos</div>
        <button class="error__button error__button--active">INCIO</button>
        <button class="error__button">CONTACTAR</button>
    </div>
